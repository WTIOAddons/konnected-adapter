# Credit to Dan Krause https://gist.github.com/dankrause/6000248
# Converted to Python3 by Adam Baxter <voltagex@voltagex.org>
...
def discover(service, timeout=5, retries=1, mx=3):
    ...
    for _ in range(retries):
        ...
        message_bytes = message.format(*group,
                                       st=service,
                                       mx=mx).encode('utf-8')
